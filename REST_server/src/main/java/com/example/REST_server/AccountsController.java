...
public class AccountsController {
	...
	Accounts account2 = new Accounts("<uid" + counter.getAndIncrement() + ">", "CSR #1",  "01",  "West Main St.", 60616, "(847) 842-8048", "http://example.com/images/jane-smith.jpeg", true, formatted_date);
